...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/create-faculty").access("hasRole('ADMINISTRATOR')")
		.antMatchers("/entrantRegistration").access("hasRole('USER')")
		.antMatchers("/rating").access("hasRole('USER')  or hasRole('ADMINISTRATOR')")
		.antMatchers("/registeredEntrants").access("hasRole('ADMINISTRATOR')")
